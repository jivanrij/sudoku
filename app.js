class SudokuApp {
  constructor() {
    ...
    this.encouragementMessages = [
      ...
      "Sometimes a break helps! Come back stronger! ☕",
      "You're training your brain! Keep it up! 🎓",
      "Every expert was once a beginner! 🌱",
      "Slow and steady wins the race! 🐢",
      "Your concentration is admirable! 🎯",
      "Challenging puzzles make victories sweeter! 🍯",
      "You're building mental muscles! 💪",
      "The journey is as important as the destination! 🛤️",
      "Believe in yourself! You can solve this! 🌟",
      "Each number placed is progress! 📈",
      "You're getting better with every game! 🚀",
      "Take a moment to see the patterns! 👁️",
      "Your dedication is inspiring! 💝",
      "Great things take time! ⏰",
      "You're absolutely crushing it! 🔨",
      "Strategy beats speed every time! ♟️",
      "Your focus is incredible! 🔍",
      "Keep calm and Sudoku on! 😌",
      "You're a puzzle-solving warrior! ⚔️",
      ...
      "You've got the eye of a detective! 🔍",
      "Keep pushing, victory is near! 🏁",
      "You're thinking like a champion! 👑",
      "Every cell filled is a win! ✅",
      "Your logic skills are shining! 💡",
      "This is your moment to shine! ✨",
      "You're becoming a Sudoku master! 🎓",
      "Look at you go! Amazing! 🎉",
      "Your determination is unmatched! 🔥",
      "You're solving this like a pro! 🏅",
